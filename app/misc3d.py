...
try:
    ...
    print('[ERROR] misc3d is not installed!')
    exit(0)
import glob
import os
import platform
...
class AppWindow:
    ...
    def _on_layout(self, layout_context):
        ...
        #                                       width, height)
        self._settings_panel.frame = gui.Rect(r.x, r.y, width, r.height)
    ...
    def _on_menu_about(self):
        ...
        dlg_layout.add_child(gui.Label("Misc3D GUI App"))
